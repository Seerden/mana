                    ...
                    <ul className="PreReview__settings--list">
                        <li key="review-cycles">
                            ...
                            <p className="PreReview__settings--tip">
                                This is the number of times you need to get each term
                                right to complete the session.
                            </p>
                        ...
                        <li key="review-direction">
                            <label
                                className="PreReview__settings--label"
                                htmlFor="direction"
                            >
                                Direction:
                            </label>
                            <div className="PreReview__settings--tip">
                                <div>
                                    'Forwards' means you're shown the front, and need to
                                    recall the back of the card.
                                </div>
